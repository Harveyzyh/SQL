...
AND CA013 = '1'
AND (
	(NOT EXISTS (SELECT 1 FROM  BOMMD WHERE MD001 = CA003 AND MD013 = 'Y') AND EXISTS (SELECT 1 FROM BOMMD WHERE MD001 = CA003))
	OR 
	NOT EXISTS (SELECT 1 FROM  BOMCB WHERE CB001 = CA003 AND CB015 = 'Y')
)
