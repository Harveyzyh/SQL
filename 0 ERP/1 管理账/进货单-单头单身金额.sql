...
SELECT TI001, TI002, 
-- UPDATE PURTI SET 
TI022 = TI022C, TI011 = TI011C, TI015 = TI015C, TI028 = TI028C, TI029 = TI029C
FROM PURTI
INNER JOIN 
(
SELECT TJ001C = TJ001, TJ002C =TJ002, 
TI022C = SUM(TJ009), TI011C = SUM(TJ030), TI015C = SUM(TJ031), TI028C = SUM(TJ032), TI029C = SUM(TJ033)  
FROM PURTJ 
INNER JOIN PURTI ON TI001 = TJ001 AND TI002 = TJ002

GROUP BY TJ001, TJ002
) AS A ON TI001 = TJ001C AND TI002 = TJ002C
WHERE 1=1
