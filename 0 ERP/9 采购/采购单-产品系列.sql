...
DECLARE TC_cursor  cursor for  SELECT TC001, TC002 FROM PURTC WHERE PURTC.UDF07 IS NULL AND PURTC.TC003 >= '20210420' AND PURTC.TC001 IN ('3301', '3308') ORDER BY TC004, TC001, TC002
OPEN TC_cursor
