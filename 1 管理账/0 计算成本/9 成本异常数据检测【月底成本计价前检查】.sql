...
WHERE SUBSTRING(TA003,1,6)='202009' AND SUBSTRING(TB008,1,6)='202009'
AND TA024='Y' AND TA079='1' --AND TB004='1'
AND TB017<>TH047 
ORDER BY TB001,TB002,TB003

-- 2.进货日期非当月，进货单本币税前<>本币税前-价差
...
WHERE SUBSTRING(LA004,1,6)='202009'
AND TH047<>LA013

-- 5.退货日期当月，退货单本币税前<>发票本币税前
...
WHERE SUBSTRING(LA004,1,6)='202009' AND LA013<>0 AND LH002 IS NULL
-- AND LA006 LIKE '56%'
...
AND TQ001='7G01' AND TQ002='20090001' 

SELECT TB001,TB002,TB003,TB004,TB005,TB006,TB007
FROM ACPTA LEFT JOIN ACPTB ON TA001=TB001 AND TA002=TB002 
WHERE SUBSTRING(TA003,1,6)='202009' AND TA024='Y' AND TB004='1'
AND EXISTS (SELECT 1 FROM ACPTQ WHERE TQ010=TB005 AND TQ011=TB006 AND TQ012=TB007 AND TQ001='7G01' AND TQ002='20090001')
...
WHERE TQ001='7G01' AND TQ002='20090001' AND TB012='Y'
