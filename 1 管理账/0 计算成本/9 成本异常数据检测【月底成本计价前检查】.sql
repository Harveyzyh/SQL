...
WHERE SUBSTRING(TA003,1,6)='201909' AND SUBSTRING(TB008,1,6)='201909'
...
WHERE SUBSTRING(LA004,1,6)='201909'
AND TH047<>LA013
...
WHERE SUBSTRING(LA004,1,6)='201909' AND LA013<>0 AND LH002 IS NULL
-- AND LA006 LIKE '56%'
...
AND TQ001='7G01' AND TQ002='19090001' 

SELECT TB001,TB002,TB003,TB004,TB005,TB006,TB007
FROM ACPTA LEFT JOIN ACPTB ON TA001=TB001 AND TA002=TB002 
WHERE SUBSTRING(TA003,1,6)='201909' AND TA024='Y' AND TB004='1'
AND EXISTS (SELECT 1 FROM ACPTQ WHERE TQ010=TB005 AND TQ011=TB006 AND TQ012=TB007 AND TQ001='7G01' AND TQ002='19090001')
...
WHERE TQ001='7G01' AND TQ002='19090001' AND TB012='Y'
