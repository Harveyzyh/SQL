...
RTRIM(TB003) 作业程序, RTRIM(ADMMB.MB002) 程序名称, RTRIM(TB004) 作业人, RTRIM(DSCMA.MA002) 姓名, TB006 作业时间, RTRIM(TB007) 数据主键, TB005 变更 FROM COMFORT..ADMTB
...
AND CONVERT(varchar(10),TB006, 112) >= '20200101'
...
-- AND TB003 = 'COPMI14'
-- AND TB007 = '601030872'
-- AND TB005 LIKE '%[10570312]%'
-- AND TB007 LIKE '10620101-SEK W09-01黑 完成品%'
...
---- 订单
-- AND TB003 = 'COPI06'
-- AND TB007 LIKE '2201-2020070027%'
...
---- 领料单
-- AND TB003 = 'MOCMI03'
-- AND TB007 LIKE '5406-2020072546%'
