...
LEFT JOIN PURTD ON PURTD.TD004 = TB004 AND PURTD.TD026 = TB001 AND PURTD.TD027 = TB002 AND PURTD.TD028 = TB003 --采购单身
...
WHERE 1=1 
AND RTRIM(COPTD.TD001) + '-' + RTRIM(COPTD.TD002) IN ('2211-014221', '2211-014224') 
--AND COPTD.TD003 = '0001' 
AND PURTB.TB004 = '3069907032' --请购品号 
