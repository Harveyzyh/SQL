...
TE003 AS 领退料单序号, (CASE SUBSTRING(TC001,1,2) WHEN '54' THEN '领料' WHEN '56' THEN '退料' ELSE TC001 END) 领退料, TE005 AS 领退料数量, TE027 AS 领退料库存数量, TE008 AS 领料单仓位, TE010 AS 领料单批号, 
...
--UPDATE MOCTE SET TE027 = LA011 --领退料库存数量
